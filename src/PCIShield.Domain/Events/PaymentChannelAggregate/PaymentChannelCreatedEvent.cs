...
{
    public class PaymentChannelCreatedEvent : BaseDomainEvent
    {
        public PaymentChannelCreatedEvent(PaymentChannel paymentChannel, string action)
        {
            ...
            EventType = "PaymentChannelCreated";
