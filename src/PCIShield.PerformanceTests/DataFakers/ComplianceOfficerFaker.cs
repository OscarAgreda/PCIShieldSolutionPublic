...
public sealed class ComplianceOfficerFaker : Faker<ComplianceOfficerDto>
{
    private static readonly object _lock = new();
    private static int _seedCounter = 0;

    public ComplianceOfficerFaker(int? seed = null)
    {
        lock (_lock)
        {
    ...
    public ComplianceOfficerDto GenerateWithRelations(Dictionary<string, object> relations = null)
    {
        var entity = Generate();
