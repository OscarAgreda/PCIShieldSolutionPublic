...
{
    public class ComplianceOfficerChatMessageSinalRModel
    {
        ...
        public Guid ReceivedConversationMoreInfoId { get; set; }
        public Guid ReceivedMerchantUserId { get; set; }
        public Guid ReceivedUnansweredConversationId { get; set; }
